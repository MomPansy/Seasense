from load import VesselDeparturesLoader
...
from transform import VesselDeparturesTransformer
import traceback
...
def main(data_for_past_n_hours=24):
    try:
        ...
        endpoint = f"https://sg-mdh-api.mpa.gov.sg/v1/vessel/departure/date/{now}/hours/{data_for_past_n_hours}"
        ...
        transformer = VesselDeparturesTransformer(data_name, pytz.timezone("Asia/Singapore"))
        ...
        loader = VesselDeparturesLoader(data_name)
